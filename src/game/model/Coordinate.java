...
/**
 * Cette classe représente les coordonnées d'une cellule dans le labyrinthe du
 * jeu.
 */
public class Coordinate {
    ...
    /**
     * Constructeur de la classe Coordinate avec les valeurs en ligne et en colonne
     * données.
     * 
